...
- **Search & sort** — search by name (pushed to SQL), sort by any column (via SQL ORDER BY)
- **Profile view** — click any name for detailed event-by-event results with NR/CR/WR ranks, all from the DB
